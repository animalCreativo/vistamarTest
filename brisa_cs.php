        ...
        <div class="row mt-minus-30">
          ...
          <div class="sobrepuesto paddingTop10">
					<div class="imgbotella">
						<img src="img/11brcsen.png" class="img-center img-responsive centrar-div-pos" alt="BRISA CABERNET SAUVIGNON">
					</div>
				</div> <!-- end col -->
          ...
          <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 descrip-vino">
            ...
            <div class="info-ow mt-30">
              ...
              <br>
              <h6>Viniﬁcación</h6>
              La vinificación está orientada a realzar los sabores y aromas típicos de la variedad, obteniendo vinos frescos, frutosos, de taninos suaves y amistosos.
              <br><br>
              <h6>Degustación</h6>
              <h3>Color:</h3> Rojo rubí con reflejos violetas.
              <h3>Aroma:</h3> Frutillas y ciruelas maduras, aromas dulces y final especiado.
              <h3>Sabor:</h3> Frutos rojos, taninos suaves, de final dulce y agradable.
              <h3>Temperatura de consumo:</h3> 16-18°C.
              <h3>Maridaje:</h3> Carnes rojas, solomillo de cerdo y empanadas de carne.
              <br><br>
              <a href="files/Brisa_CS_16.pdf" target="_blank" class="btn btn-lg btn-color">Bajar Archivo</a>
              <a href="http://www.cavamorande.cl/store/vina-vistamar/vistamar-brisa-cabernet-sauvignon-2014" target="_blank" class="btn btn-lg btn-color">Comprar</a>
            </div>
          </div> <!-- end col -->   
