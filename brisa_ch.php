        ...
        <div class="row mt-minus-30">
          ...
          <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 descrip-vino">
            ...
            <div class="info-ow mt-30">
              <h1 style="text-transform: uppercase">Chardonnay</h1>
              <br>
              <h3>Origen</h3>
              <h5>Valle Central</h5>
              ...
              <h3>Aroma:</h3> Limpio y frutal, destacan las peras maduras y delicadas notas cítricas.
              <h3>Sabor:</h3> Frutoso, fresco, redondo y envolvente.
              <h3>Temperatura de consumo:</h3> 8-10°C.
              <h3>Maridaje:</h3> Pollo o pavo, crustáceos gratinados y pescados con cremas.
              <br><br>
              <a href="files/Brisa_Ch_17.pdf" target="_blank" class="btn btn-lg btn-color">Bajar Archivo</a>
              <a href="http://www.cavamorande.cl/store/vistamar-brisa/vistamar-brisa-chardonnay-2015" target="_blank" class="btn btn-lg btn-color">Comprar</a>
            </div>
          </div> <!-- end col -->   
