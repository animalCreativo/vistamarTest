            ...
            <li data-transition="zoomout"
              ...
              <div class="col-lg-8 fondo-blanco ow-description">
              	...
              	<div class="info-ow">
              		...
              		<h3>VALLE</h3>
              		<h5>Maipo</h5>
					<p>Este vino representa todo nuestro potencial y experiencia. Se trata de un vino de terroir, cultivado en cuarteles específicos de nuestros viñedos en Maipo Andes.
					<br><br>
					Cada una de sus etapas ha sido cuidadosa y meticulosamente determinada con el objetivo de lograr una calidad de nivel superior con identidad, personalidad única y una larga vida en la botella.
					</p>
